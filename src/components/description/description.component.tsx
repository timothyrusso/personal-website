...
export const Description = () => {
    return (
        <DescriptionComponent>I’m a motivated and passionate Frontend Engineer with a background in eCommerce, Quality Assurance, Application Delivery Management, Project Management and Trade Marketing.
            ...
            I’m a curious person, I love to code and I like to experiment with new technologies. Coding is my passion and my professional career focus. My experience gives me a solid foundation of problem solving and team cooperation.</DescriptionComponent>
    )
}